...
<optgroup label="<?php echo esc_attr (_x ("Authorize.Net (Subscriptions)", "s2member-admin", "s2member")); ?>">
...
<optgroup label="<?php echo esc_attr (_x ("Authorize.Net (Buy Now)", "s2member-admin", "s2member")); ?>">
