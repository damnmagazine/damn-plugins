...
if (!class_exists ("c_ws_plugin__s2member_pro_admin_css_js"))
	{
		/**
		* Administrative CSS/JS.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__s2member_pro_admin_css_js
			{
				/**
				* Adds JavaScript for s2Member Pro menu pages.
				*
				* @package s2Member\Admin_CSS_JS
				* @since 1.5
				*
				...
				*
				* @param array $vars Expects array of defined vars passed through by Filter.
				* @return null
				*/
