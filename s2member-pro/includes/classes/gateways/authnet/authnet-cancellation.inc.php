<?php
/**
* Authorize.Net Cancellation Form handler.
*
* Copyright: © 2009-2011
...
if (!class_exists ("c_ws_plugin__s2member_pro_authnet_cancellation"))
	{
		/**
		* Authorize.Net Cancellation Form handler.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__s2member_pro_authnet_cancellation
			{
				/**
