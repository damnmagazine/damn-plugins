<?php
/**
* Authorize.Net Registration Form processing.
*
* Copyright: © 2009-2011
...
if (!class_exists ("c_ws_plugin__s2member_pro_authnet_registration"))
	{
		/**
		* Authorize.Net Registration Form processing.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__s2member_pro_authnet_registration
			{
				/**
