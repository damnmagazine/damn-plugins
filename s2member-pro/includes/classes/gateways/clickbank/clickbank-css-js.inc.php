...
if (!class_exists ("c_ws_plugin__s2member_pro_clickbank_css_js"))
	{
		/**
		* ClickBank CSS/JS for theme integration.
		*
		...
		class c_ws_plugin__s2member_pro_clickbank_css_js
			{
				...
				* @return null
				*/
				public static function clickbank_css ($vars = FALSE)
					{
						...
						|| has_action ("ws_plugin__s2member_during_css", "c_ws_plugin__s2member_pro_css_js::css")) // Only if CSS loads.
							// This check allows a site owner to disable all CSS by removing the main CSS Hook in one shot.
							{
								...
								include_once dirname (dirname (dirname (dirname (__FILE__)))) . "/separates/gateways/clickbank/clickbank.css";
							}
				...
				public static function clickbank_js_w_globals ($vars = FALSE)
					{
						...
						include_once dirname (dirname (dirname (dirname (__FILE__)))) . "/separates/gateways/clickbank/clickbank-min.js";
