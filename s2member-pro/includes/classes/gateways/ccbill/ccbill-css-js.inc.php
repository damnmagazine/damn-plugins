...
if (!class_exists ("c_ws_plugin__s2member_pro_ccbill_css_js"))
	{
		/**
		* ccBill CSS/JS for theme integration.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__s2member_pro_ccbill_css_js
			{
				/**
				...
				* @return null
				*/
				public static function ccbill_css ($vars = FALSE)
					{
						...
						|| has_action ("ws_plugin__s2member_during_css", "c_ws_plugin__s2member_pro_css_js::css")) // Only if CSS loads.
							// This check allows a site owner to disable all CSS by removing the main CSS Hook in one shot.
							{
								...
								include_once dirname (dirname (dirname (dirname (__FILE__)))) . "/separates/gateways/ccbill/ccbill.css";
							}
				...
				* @return null
				*/
				public static function ccbill_js_w_globals ($vars = FALSE)
					{
						$g = "var S2MEMBER_PRO_CCBILL_GATEWAY = true,";
						...
						include_once dirname (dirname (dirname (dirname (__FILE__)))) . "/separates/gateways/ccbill/ccbill-min.js";
