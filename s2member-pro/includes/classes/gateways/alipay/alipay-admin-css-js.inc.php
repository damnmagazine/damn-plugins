...
if (!class_exists ("c_ws_plugin__s2member_pro_alipay_admin_css_js"))
	{
		/**
		* Administrative CSS/JS.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__s2member_pro_alipay_admin_css_js
			{
				/**
				...
				* @return null
				*/
				public static function alipay_menu_pages_js ($vars = FALSE)
					{
						echo "\n"; // Add a line break before inclusion of this file.
						include_once dirname (dirname (dirname (dirname (__FILE__)))) . "/menu-pages/alipay-menu-pages-s-min.js";
