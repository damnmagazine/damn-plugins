...
if(!class_exists('c_ws_plugin__s2member_pro_stripe_constants'))
{
	/**
	 * Stripe API Constants *(for site owners)*.
	 *
	 ...
	 * @since 140617
	 */
	class c_ws_plugin__s2member_pro_stripe_constants
	{
		/**
		 * Stripe API Constants *(for site owners)*.
		 *
		...
		public static function stripe_constants($c, $vars)
		{
			 ...
			 * @var bool
			 */
			if(!defined('S2MEMBER_PRO_STRIPE_GATEWAY'))
				define('S2MEMBER_PRO_STRIPE_GATEWAY', ($c[] = TRUE));
