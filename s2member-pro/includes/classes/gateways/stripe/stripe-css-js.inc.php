...
if(!class_exists('c_ws_plugin__s2member_pro_stripe_css_js'))
{
	/**
	 ...
	 * @since 140617
	 */
	class c_ws_plugin__s2member_pro_stripe_css_js
	{
		/**
		...
		public static function stripe_css($vars)
		{
			...
			if(!apply_filters('ws_plugin__s2member_pro_css_affects_gateways', TRUE)
			   || has_action('ws_plugin__s2member_during_css', 'c_ws_plugin__s2member_pro_css_js::css')
