<?php
/**
* Google CSS/JS for theme integration.
*
* Copyright: © 2009-2011
...
if (!class_exists ("c_ws_plugin__s2member_pro_google_css_js"))
	{
		/**
		* Google CSS/JS for theme integration.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__s2member_pro_google_css_js
			{
				/**
				...
				* @return null
				*/
				public static function google_css ($vars = FALSE)
					{
						...
						|| has_action ("ws_plugin__s2member_during_css", "c_ws_plugin__s2member_pro_css_js::css")) // Only if CSS loads.
							// This check allows a site owner to disable all CSS by removing the main CSS Hook in one shot.
							{
								...
								include_once dirname (dirname (dirname (dirname (__FILE__)))) . "/separates/gateways/google/google.css";
							}
				...
				* @return null
				*/
				public static function google_js_w_globals ($vars = FALSE)
					{
						$g = "var S2MEMBER_PRO_GOOGLE_GATEWAY = true,";
