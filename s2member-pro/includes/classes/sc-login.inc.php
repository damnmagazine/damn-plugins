...
if(!class_exists('c_ws_plugin__s2member_pro_sc_login'))
{
	/**
	 * [s2Member-Login] Shortcode.
	 *
	 ...
	 * @since 150712
	 */
	class c_ws_plugin__s2member_pro_sc_login
	{
		/**
		 * [s2Member-Login] Shortcode.
		 *
		...
		{
			return c_ws_plugin__s2member_pro_sc_login_in::shortcode($attr, $content, $shortcode);
		}
	}
}
