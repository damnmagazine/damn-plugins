...
*/
add_action('init', 'c_ws_plugin__s2member_pro_google_jwt::google_jwt', 4);
add_action('init', 'c_ws_plugin__s2member_pro_google_return::google_return', 4);
add_action('init', 'c_ws_plugin__s2member_pro_google_notify::google_notify', 4);

add_filter('ws_plugin__s2member_during_constants_c', 'c_ws_plugin__s2member_pro_google_constants::google_constants', 10, 2);

add_action('ws_plugin__s2member_during_css', 'c_ws_plugin__s2member_pro_google_css_js::google_css');
